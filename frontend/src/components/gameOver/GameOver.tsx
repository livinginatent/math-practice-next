...
const GameOver = ({ lostBy, newGame, finalScore }: GameOverComponent) => {
  return (
    <div className="flex bg-[#fff6f6] rounded-lg text-4xl text-center items-center flex-col absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-1/2">
